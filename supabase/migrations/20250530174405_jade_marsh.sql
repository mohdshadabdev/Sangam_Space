...
SET 
  name = 'Codify Club',
  description = 'United University''s most vibrant coding club. Open for beginners and pros. We organize workshops, hackathons, and more.',
  logo_url = 'https://pps.whatsapp.net/v/t61.24694-24/442457938_714514990705048_4031384478786705579_n.jpg?ccb=11-4&oh=01_Q5Aa1gH3l47afkBkZe4gS5Az8zHYCSGkJoTxFSzZAt1qCRNDQw&oe=684710BB&_nc_sid=5e03e0&_nc_cat=106',
  color_theme = '#3B82F6'
...
SET 
  name = 'TFUG',
  description = 'A developer community for those passionate about TensorFlow and ML technologies.',
  logo_url = 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSosJ9Inu4Nq4ZiwL97eDq8diTournVlAfnGA&s',
  color_theme = '#EC4899'
WHERE id = 'd4e5f6a1-b2c3-7890-abcd-ef1234567893';

UPDATE clubs 
SET 
  name = 'GDG Prayagraj',
  description = 'Google Developers Group Prayagraj is for developers interested in Google''s tech—from Android to Maps API. We host Codelabs, devFests, and more. Free and open to all tech enthusiasts.',
  logo_url = 'https://media.konfhub.com/event_poster/2024/October/08/1728587723424-6e4f70aa-fbb7-4c99-9a45-151d6254d9be.png',
  color_theme = '#22C55E'
WHERE id = 'e5f6a1b2-c3d4-7890-abcd-ef1234567894';
...
-- Delete existing events for these clubs
DELETE FROM events WHERE club_id IN (
  'e5f6a1b2-c3d4-7890-abcd-ef1234567894',
  'd4e5f6a1-b2c3-7890-abcd-ef1234567893',
  'a1b2c3d4-e5f6-7890-abcd-ef1234567890',
  'f6a1b2c3-d4e5-7890-abcd-ef1234567895'
);
